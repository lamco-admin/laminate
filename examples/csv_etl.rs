...
fn main() {
    ...
    for (i, row) in rows.iter().enumerate() {
        let val = FlexValue::from_json(row).unwrap()
        ...
        println!("Row {}: price={:.2}, weight={:.1}, active={}", i + 1, price, weight, active);
    }
